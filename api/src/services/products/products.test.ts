...
describe('products', () => {
  ...
  scenario('creates a product', async () => {
    ...
    expect(result.price).toEqual(8185441.269577725)
    expect(result.stockCount).toEqual(639892)
    expect(result.updatedAt).toEqual('2022-09-11T14:54:13Z')
  })
